...
[[weeks]]
  number = 2
  date   = 2026-04-22
  title  = "Map reading & local geography"
  themes = ["outdoor-and-adventure", "skills-for-life"]
  notes  = "Bring a pencil. We'll be working in pairs on Ordnance Survey extracts of the local hill."
...
[[weeks]]
  number = 5
  date   = 2026-05-13
  title  = "Knot relay & team challenge"
  themes = ["teamwork-and-leadership", "skills-for-life"]
  notes  = "Outdoor if dry; we'll move into the hut if it's wet."
...
[[weeks]]
  number = 8
  date   = 2026-06-17
  title  = "Cooking on a single hob"
  themes = ["skills-for-life", "have-adventures"]
  notes  = "Camp preparation. We'll cook the sausages-and-pasta meal we'll be using on camp."
...
[[weeks]]
  number = 11
  date   = 2026-07-15
  title  = "End-of-term party & badge presentations"
  themes = ["beliefs-and-attitudes", "live-up-to-our-values"]
  notes  = "Casual dress. Final meeting of the term."
+++
